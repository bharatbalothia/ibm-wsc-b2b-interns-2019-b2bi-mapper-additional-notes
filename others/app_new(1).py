...
def ldapAuth():
    ...
    session['username'] = "Administrator"#str(userName)
    ...
    if request.method =='POST':
        ...
        if file:
            ...
            if(idForUser==""):
                ...
                dictSaved['usage'] = [{'fileName':filenameUploaded,'time':timeaccessed}]
                dictSaved['team'] = select
                
            #else append usage list
            else:
                # dictSaved['_id'] = session['username']
                dictSaved['usage'].append({'fileName':filenameUploaded,'time':timeaccessed})
                dictSaved['team'] = select
